            ...
            errorString: function() {
                if (_.isObject(values)) {
                    return invalidKeys.map(function(key) {
                        if (_.isEmpty(values[key])) return 'missing named argument ' + key;
...
var Validate = {
    ...
    validatePositional: function(posArguments, validationSpec) {
        ...
        if ((_.isArray(posArguments) || _.isArguments(posArguments)) && !_.isEmpty(posArguments)) {
            ...
            errors = ['missing positional arguments'];
            posArguments = null;
        }
